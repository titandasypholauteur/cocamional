...
'    <section style="text-align: center;">'+
'        <button>'+
'            <a href="stations.html">Trajets possibles et stations</a>'+
'        </button>'+
'    </section>'+
''+
'    <main>'+
'        <p>Nous t\'aidons à trouver le conducteur/la conductrice et/ou les passager.e.s grâce à qui tu vivras un trajet unique.</p>'+
'        <br />'+
''+
'        <p class="champ">'+
'            <label for="departure">Station de départ</label>'+
'            <input id="departure" name="departure" />'+
'        </p>'+
''+
'        <p class="champ">'+
'            <label for="destination">Station de destination</label>'+
